...
use memchr;
use memchr::Memchr;
use nom::{AsBytes, AtEof, Compare, CompareResult, FindSubstring, FindToken, InputIter, InputLength,
...
impl<'a> InputTake for LocatedSpan<CompleteStr<'a>> {
  ...
  fn take_split(&self, count: usize) -> (Self, Self) {
    ...
    let right_span = LocatedSpan { line: self.line, offset: self.offset, fragment: right_fragment };
